    ...
    <div className="app">
      ...
      <div className="content">
        <Routes>
          ...
          <Route path="/turn" element={setup ? (winner ? <Navigate to="/victory" replace /> : <EmpirePage />) : <Navigate to="/" replace />} />
          ...
          <Route path="*" element={<Navigate to={setup ? (winner ? '/victory' : '/turn') : '/'} replace />} />
        </Routes>
      </div>
    </div>
  );
